...
def get_sheetmap():
    with open('torrents/data/sheet_map.json', 'r') as f:
        sheet_map = json.load(f)
    return sheet_map

def get_bad_sheet_ids():
    bad_sheets_file = Path('torrents/bad_sheets.txt')
...
def process_files():
    ...
    data_dir = Path('torrents/data/raw')
    ...
    special_cases_file = Path(__file__).parent / 'torrents'/ 'special_cases.json'
    ...
    for filepath in image_files:
        ...
        sheet_props['source_type'] = 'torrents'
